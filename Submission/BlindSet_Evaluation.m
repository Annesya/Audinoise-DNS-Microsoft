% Evaluation
% duration = zeros(700,1);
for testnum = 1:5
fprintf(['Count Number: ',num2str(testnum),'\n']); 
noisyFile = table2array(ICASSPDNSBLIND(testnum,1));
addpath('D:\DNS-Challenge\datasets\ICASSP_blind_test_set\track_1\noisy\');
